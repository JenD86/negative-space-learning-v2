...
class MetricsGenner(Genner):
    ...
    def extract_code(self, response: str):  # pyright: ignore[reportIncompatibleMethodOverride]
        return self.inner.extract_code(response)

    def extract_list(self, response: str):  # pyright: ignore[reportIncompatibleMethodOverride]
